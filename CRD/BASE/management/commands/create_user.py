...
class Command(BaseCommand):
    help = '--Create a new user \
         --example :   python manage.py create_user --username alice --email alice@example.com --password 123456 --organization AcmeInc --type cgartist --role ANIM'
    ...
    def handle(self, *args, **options):
        ...
        if user_type == "producer":
            ...
            profile = UserProfile.objects.create(user=user, type=user_type,organization=organization)
